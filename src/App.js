...
const JoinNowSection = () => (
    <section className="relative py-20 text-white text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg mb-8">아래 버튼을 클릭하여 신청폼을 작성해 주세요.</p>
            <ApplyButton />
        </div>
    </section>
);
...
const App = () => {
    const targetAudience = [
        ...
        },
        {
            ...
            items: [
                "프리랜서로 활동하며, 강의를 통해 추가 수익을 창출하고 싶은 분",
                "교육 사업을 시작하고자 하는 분"
            ]
        },
        {
    ...
    const programContent = [
        {
            ...
            items: [
                { title: "성향 및 장점 파악", description: "참가자의 개인적 특성과 강점을 분석하여 강의 방향을 설정합니다." },
    ...
    const completionBenefits = [
        {
            icon: Award,
            title: "공식 수료증 발급",
            description: "• 프로그램 수료를 인증하는 공식 수료증을 발급받아, 이력서와 포트폴리오에 활용 가능\n• 강사로서의 경력을 공식적으로 증명할 수 있는 기회 제공"
        },
        {
            icon: Upload,
            title: "강의 콘텐츠 배포",
            description: "• 참가자가 제작한 강의를 파이프 코칭캠프 공식계정 게시 권한 부여\n• 다수의 온라인 강의플랫폼 게시\n• 강사로서 개인 브랜드 및 전문성을 널리 알릴 수 있는 기회 제공"
        },
        {
            icon: DollarSign,
            title: "수익화 기회",
            description: "• 제작한 강의를 통해 직접 수익을 창출할 수 있는 기회 제공\n• 파이프 코칭캠프 공식 계정 강의 게시로 더 많은 잠재 고객에게 도달, 수익화 극대화\n• 다양한 수익화 모델(구독, 일회성 판매 등)에 대한 지속적인 지원"
        },
        {
            icon: Users,
            title: "멘토링 및 네트워킹",
        ...
        },
        {
            ...
            description: "• 프로그램 수료 후 전용 커뮤니티에 참여하여, 선별된 정예 멤버들과의 경험 공유 및 협업 기회 제공\n• 새로운 아이디어와 트렌드를 배우고 나눌 수 있는 공간 제공"
        },
        {
            icon: Zap,
            title: "'method.' 이용 할인 혜택",
            description: "• AI 서비스 기획 솔루션 'method.'를 할인된 가격으로 이용할 수 있는 혜택 제공"
        },
        {
            icon: Code,
            title: "'Code Room' 이용 할인 혜택",
            description: "• 소스코드 거래 플랫폼 'Code Room'을 할인된 가격으로 이용할 수 있는 혜택 제공"
        }
    ];
            ...
            <SmallSection title="환불 규정 안내" bgColor="bg-gray-50" icon={RefreshCcw}>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                    <p className="text-sm text-gray-600 mb-4 text-center italic">
                        환불 규정 : 환불 신청 시 학원법 규정에 근거하여 참여 횟수에 따라 환불금이 정해집니다.
                    </p>
                    <ul className="list-none space-y-2 text-sm">
                        {[
                            { period: "파이프 코칭캠프 시작 전", refund: "100% 환불" },
                            { period: "파이프 코칭캠프 1/3 경과 전 (시작 후 10일 전까지)", refund: "참가비 2/3에 해당하는 금액" },
                            { period: "파이프 코칭캠프 1/2 경과 전 (시작 후 14일 전까지)", refund: "참가비 1/2에 해당하는 금액" },
                            { period: "파이프 코칭캠프 1/2 경과 후 (시작 후 14일 이후)", refund: "환불 불가" }
                        ].map((item, index) => (
